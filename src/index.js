document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    */
    ...
    question.choices.forEach((element, idx) => {
      // new input:radio
      const option = document.createElement('input')
      option.type = 'radio'
      option.name = 'choice'
      option.value = element
      option.id = `option-${idx}`
      // new label for
      const label = document.createElement('label')
      label.setAttribute('for', `option-${idx}`)
      label.innerText = element
      // new li - cotainer of input and label
      const optionContainer = document.createElement('li')
      optionContainer.append(option, label)
  ...
  function nextButtonHandler() {
    ...
    const allChoices = document.querySelector('#choices').querySelectorAll('input')
